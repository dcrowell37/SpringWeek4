...
import com.pt.jeep.Constants;
import com.pt.jeep.controller.support.FetchJeepTestSupport;
import com.pt.jeep.entity.Jeep;
import com.pt.jeep.entity.JeepModel;
import com.pt.jeep.service.JeepSalesService;
...
class FetchJeepTest extends FetchJeepTestSupport {
  ...
  class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport {
    ...
    @ParameterizedTest
    @MethodSource("com.pt.jeep.controller.FetchJeepTest#parametersForInvalidInput")
  ...
  static Stream<Arguments> parametersForInvalidInput() {
    // @formatter:off
    return Stream.of(
            arguments("WRANGLER", "@3$%^&&%", "Trim contains non alpha-numeric characters"),
